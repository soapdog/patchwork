...
module.exports = function Window(
  ...
  window.once("ready-to-show", () => {
    if (!opts.title.startsWith("patchwork-server")) {
      window.show();
    }
  });
  ...
  // TODO: better way to determine whether this is an interface window ?
  if (opts.title.includes("Poncho Wonky")) {
    setupContextMenu(
      config,
      serverDevToolsCallback,
      navigateHandler,
