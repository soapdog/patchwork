...
const plugins = {
  ...
  backlinks: require("./backlinks.js"),
  profile: require("./profile.js"),
  suggest: require("ssb-suggest"),
  publicFeed: require("./public-feed.js"),
  subscriptions2: require("./subscriptions2.js"),
  thread: require("./thread.js"),
  privateFeed: require("./private-feed.js"),
  mentionsFeed: require("./mentions-feed.js"),
  gatherings: require("./gatherings.js"),
  networkFeed: require("./network-feed.js"),
  channelFeed: require("./channel-feed.js"),
  participatingFeed: require("./participating-feed.js"),
  channels: require("./channels.js"),
  contacts: require("./contacts.js"),
  blogs: require("./blogs.js"),
  books: require("./books.js"),
  orderOfArrivalFeed: require("./order-of-arrival-feed.js"),
};
...
exports.init = function (ssb, config) {
  ...
  ssb.auth.hook(function (fn, args) {
    const self = this;
    patchwork.contacts.isBlocking(
      { source: ssb.id, dest: args[0] },
      function (_, blocked) {
        if (blocked) {
    ...
    patchwork.contacts.raw.get((err, graph) => {
      ...
      pull(
        ...
        pull.drain(function (value) {
          ...
          if (
            replicating.has(value.author) && address && ref.isFeed(address.key)
          ) {
            // ignore blocked pubs
            const blocking = graph && graph[ssb.id] &&
              graph[ssb.id][address.key] === false;
            if (blocking) return;
  ...
  ssb.createHistoryStream.hook(function (fn, args) {
    ...
    return pCont((cb) => {
      ...
      patchwork.contacts.raw.get((_, graph) => {
        ...
        if (
          graph && feedId !== requesterId && graph[feedId] &&
          graph[feedId][requesterId] === false
        ) {
