  ...
  function buildDropdownMenuItems() {
    ...
    if (isFeatureEnabled("custom-scripts")) {
      ...
      for (const script of activeScripts) {
        ...
        const has = api.scripts.lua.environment.has(L, "menuAction");
        ...
        if (label) {
          ...
          customMenus.push({
            type: "normal",
            label: label,
            target: "/custom-script?script=" + script.name,
          });
        }
      }
    }
    ...
    console.log("multiple-identities", isFeatureEnabled("multiple-identities"));
    console.log("custom-scripts", isFeatureEnabled("customScripts"));
