...
const requireStyle = (moduleName, specificFilePath = false) => {
  ...
  const filePath = !specificFilePath ? path.resolve(stylesPath, `${moduleName}.css`) : path.resolve(stylesPath, specificFilePath)
...
module.exports = function (config) {
  ...
  const container = h(`MainWindow -${process.platform}`, {
    ...
    when(latestUpdate,
      h('div.info', [
        h('a.message -update', { href: 'https://github.com/soapdog/patchwork/releases/latest' }, [
          h('strong', ['Poncho Wonky ', latestUpdate, i18n(' has been released.')]), i18n(' Click here to download and view more info!'),
    ...
    const dropTabItems = [
      ...
      },
      {
        ...
        submenu: [
          ...
          {
            type: 'normal',
            label: i18n('Compose New Blog Post'),
            target: '/blogs-new',
          },
        ],
      },
