const { computed, h, map, Value, watch, onceTrue } = require("mutant");
...
exports.create = function (api) {
  return nest("page.html.render", function channel(path) {
    ...
    const spellcheckLangs = api.settings.obs.get("patchwork.spellcheckLangs", [
      "en-GB",
    ]);
    const enableSpellCheck = api.settings.obs.get(
      "patchwork.enableSpellCheck",
      true,
    );
    const spellcheckParams = computed(
      [spellcheckLangs, enableSpellCheck],
      (langs, enabled) => ({ langs, enabled }),
    );
    ...
    return h("Scroller", { style: { overflow: "auto" } }, [
      h("div.wrapper", [
        ...
        h("section.content", [
          ...
          h("section", [
            ...
            h("select", {
              ...
              map(availableDictionaries, (code) =>
                h("option", {
                  value: code,
          ...
          h("div", [
            checkbox(includePopular, {
              label: i18n('Include "Popular" tab in navigation bar'),
            }),
          ]),
          ...
          h("div", [
            checkbox(autoDeleteBlocked, {
              label: i18n(
                "Automatically delete messages from blocked authors. This is irreversible and will cause problems with clients that share the database but do not support deleted messages. Enable at your own risk!",
              ),
            }),
          ]),
        ]),
        ...
        h("section", [
          h("h2", i18n("Rebuild indexes")),
          h("p", [
            i18n("Click"),
            " ",
            h("a", {
              href: "#",
              "ev-click": rebuildIndexes,
            }, i18n("here")),
            " ",
            i18n("to rebuild your indexes. Might take several minutes."),
          ]),
        ]),
