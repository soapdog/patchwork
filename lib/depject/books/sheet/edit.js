        ...
        async function fetchMetadata() {
          ...
          try {
            ...
            if (metadata?.description?.value) {
              ...
              document.getElementById("textarea-description").value = work.description;
            }

            if (metadata?.series) {
              newBook.series = metadata.series[0]
              document.getElementById("input-series").value = metadata.series[0]
            }
            ...
            blobFiles(
              ...
              (err, result) => {
                ...
                newBook.images.set(result.link);
              },
            );
          } catch (error) {
            console.log(error);
