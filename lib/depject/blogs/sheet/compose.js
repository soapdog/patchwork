...
exports.create = function (api) {
  ...
  return nest("blogs.sheet.compose", function (id) {
    ...
    const blogPostTextArea = h("textarea.content", {
    ...
    */
    ...
    function afterAttach(err, file) {
      ...
      const pos = blogPostTextArea.selectionStart;
      let before = blogPostTextArea.value.slice(0, pos);
      let after = blogPostTextArea.value.slice(pos);
