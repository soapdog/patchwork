module.exports = {
  patchwork: {
    ...
    blogs: {
      sheet: {
        compose: require("./blogs/sheet/compose.js"),
      },
    },
    books: {
      sheet: {
        edit: require("./books/sheet/edit.js"),
        review: require("./books/sheet/review.js"),
      },
      html: {
        card: require("./books/html/book-card.js"),
        details: require("./books/html/book-details.js"),
      },
      sync: {
        fix: require("./books/sync/fix.js"),
      },
    },
    intl: {
      sync: {
    ...
    message: {
      ...
      html: {
        ...
        render: {
          ...
          book: require("./message/html/render/book.js"),
          bookReview: require("./message/html/render/book-review.js"),
      ...
      obs: {
        ...
        edits: require("./message/obs/edits.js"),
      },
      sheet: {
    ...
    page: {
      html: {
        render: {
          ...
          popular: require("./page/html/render/popular.js"),
          ...
          "attending-gatherings": require(
            "./page/html/render/attending-gatherings.js",
          ),
          blogs: require("./page/html/render/blogs.js"),
          books: require("./page/html/render/books.js"),
          troubleshootingTools: require(
            "./page/html/render/troubleshooting-tools.js",
          ),
          customScript: require("./page/html/render/custom-script.js"),
          storageManager: require("./page/html/render/storage-manager.js"),
          orderOfArrival: require("./page/html/render/order-of-arrival.js"),
        },
      },
    },
    profile: {
    ...
    sheet: {
      ...
      editPost: require("./sheet/editPost.js"),
